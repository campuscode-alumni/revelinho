...
describe InviteMailer do
  describe '#notify_candidate' do
    it 'should send with proper subject' do
      company = create(:company, :active, name: 'Revelo', url_domain: 'revelo.com.br')
      create(:employee, email: 'renata@revelo.com.br',
                        company: company)
      candidate = create(:candidate, name: 'Gustavo', email: 'gustavo@email.com')
      ...
      expect(mail.subject).to eq 'Gustavo, você foi convidado para uma posição na Revelo'
    end

    it 'should send to candidate email' do
      company = create(:company, :active, name: 'Revelo',
